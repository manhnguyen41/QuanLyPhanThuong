 ...
 */
public class Them_dip_thuong extends javax.swing.JFrame {
    private DipTangThuong dipTangThuong;
    /**
     * Creates new form Them_dip_thuong
     */
    public Them_dip_thuong(DipTangThuong dipTangThuong) {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(216, 25));
    ...
    private void btnLuuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuMouseClicked
        ...
        String thanhTich = tfThanhTich.getText();
        String HocKi = tfHocKi.getText();
        String chiTiet = tfSoLuong.getText();
        DipTangThuong dipTangThuong = new DipTangThuong(thanhTich, HocKi, ReadMapFromText.readMapFromText(chiTiet));
